...
const Best = () => {
  ...
  const products = [
    ...
    {
      tag: "Customise your Mac.",
      subTag: "Choose your chip, memory, storage, even colour.",
      img: "Images/Mac/Best/customise.png",
    },
    {
      tag: "Save on a new Mac with education pricing.",
    ...
    {
      tag: "Join an online Personal Setup session.",
      subTag:
        "Talk one-to-one with a Specialist to set up your Mac and discover new features.",
