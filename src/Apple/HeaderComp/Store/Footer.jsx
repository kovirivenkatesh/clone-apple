  ...
  return (
    <footer className="bg-[#f5f5f7] text-[#6e6e73] text-[13px] leading-snug">
      <div className="max-w-7xl mx-auto px-10 md:px-12 pt-6">
        ...
        {/* Large Screen Layout */}
        <div className="hidden md:grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 md:gap-10 mb-8">
          {/* Column 1 */}
          <div>
            <h4 className="font-semibold text-black mb-1">Shop and Learn</h4>
            ...
            <h4 className="font-semibold text-black mt-3 mb-1">Apple Wallet</h4>
            <ul className="space-y-[1px]">
          ...
          {/* Column 2 */}
          <div>
            <h4 className="font-semibold text-black mb-1">Account</h4>
            <ul className="space-y-[1px]">
            ...
            <h4 className="font-semibold text-black mt-3 mb-1">Entertainment</h4>
            <ul className="space-y-[1px]">
          ...
          {/* Column 3 */}
          <div>
            <h4 className="font-semibold text-black mb-1">Apple Store</h4>
            <ul className="space-y-[1px]">
          ...
          {/* Column 4 */}
          <div>
            <h4 className="font-semibold text-black mb-1">For Business</h4>
            <ul className="space-y-[1px]">
              <li><a href="#" className="hover:underline text-[#424245]">Apple and Business</a></li>
            </ul>

            <h4 className="font-semibold text-black mt-3 mb-1">For Education</h4>
            <ul className="space-y-[1px]">
            ...
            <h4 className="font-semibold text-black mt-3 mb-1">For Healthcare</h4>
            <ul className="space-y-[1px]">
          ...
          {/* Column 5 */}
          <div>
            <h4 className="font-semibold text-black mb-1">Apple Values</h4>
            <ul className="space-y-[1px]">
            ...
            <h4 className="font-semibold text-black mt-3 mb-1">About Apple</h4>
            <ul className="space-y-[1px]">
        ...
        {/* Footer Bottom */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 text-[13px]">
